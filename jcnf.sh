...
install(){
	[[ ! -d /home/tstrace/besttrace ]] && wget -O BestTrace.tar.gz https://github.com/jamespan2012/jcnfbesttrace/releases/download/1.3.2/BestTrace.tar.gz && tar -zxf BestTrace.tar.gz && rm BestTrace.tar.gz
...
node_1(){
	...
	[[ "${node}" == "2" ]] && ISP_name="上海CN2"	       && ip=58.32.8.1
...
test_all(){
	...
	result_all	'58.32.8.1'	'上海CN2'

	result_all	'139.226.227.38'   	'上海联通'

	result_all	'221.183.94.137'	'杭州移动'
